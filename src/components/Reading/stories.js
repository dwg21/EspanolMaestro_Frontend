export const story3 = `Vosotros dos podéis ir en busca de vuestra gran aventura —dijo Ari—. ¡Pero yo me quedo en casa!
...
export const story2 = `Alemania, en la Segunda Guerra Mundial...
...
export const story1 = `Capítulo 3
